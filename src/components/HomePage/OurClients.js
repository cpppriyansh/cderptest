...
const premiumClients = [
  ...
  "hdfc.avif", "God.avif", "baja.webp", "bharatpe.avif", "pizza-hut.avif",
];
    ...
    <div className="relative overflow-hidden">
      ...
      >
        {logosToUse.map((logo, index) => (
          <div
            key={`first-${index}`}
            className="flex-shrink-0 group w-[120px] h-[100px] flex items-center justify-center bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300"
          >
            <Image
              src={`/Ourclients/${logo}`}
